...
class ItemRepositoryTest {
    ...
    public void findByItemNmOrItemDetail() {
        this.createItemList();
        List<Item> itemList = itemRepository.findByItemNmOrItemDetail("테스트 상품3", "테스트 상품 상세 설명6");
        for (Item item : itemList) {
            System.out.println(item.toString());
        }
    }
    ...
    @Test
    @DisplayName("가격 내림차순 OrderBy 조회 테스트")
    ...
    public void queryDslTest2() {
        ...
        System.out.printf("total elements : " + itemPagingResult. getTotalElements());
